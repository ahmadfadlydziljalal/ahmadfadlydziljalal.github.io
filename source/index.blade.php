            ...
            <div class="flex flex-column flex-gap-1">
                ...
                <div class="flex flex-column flex-gap-1 align-items-center">
                    <p class="order-1 order-sm-2">
                        ...
                        Intermediate Backend dan
                        Intermediate Frontend
                    </p>
                    <div class="order-2 order-sm-1">
                        <img src="assets/images/papa.svg" width="auto" height="200rem" style="transform:scaleX(-1)" />
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="flex flex-sm-column flex-md-row flex-lg-column flex-gap-1 align-items-center">
                    ...
                    <div class="order-2 order-sm-1">
                        <a href="https://www.yiiframework.com/" target="_blank" rel="noopener noreferrer">
                            <svg xmlns:serif="http://www.serif.com/" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 650.832 800" style="enable-background:new 0 0 650.832 800;" xml:space="preserve" width="auto" height="16rem">
                                <style type="text/css">
                                    .st0 {
                                        fill: #40B3D8;
                                    }
        ...
        <div class="card animate__animated animate__backInRight">
            <div class="flex flex-column flex-gap-1">
                ...
                <div class="flex flex-sm-column flex-md-row flex-lg-column flex-gap-1 align-items-center">
                    ...
                    <p class="order-1 order-sm-2">
                        Routing, Middleware, Blade, Eloquent, Validation, Logging, Testing, Spatie Permission

                    <div class="order-2 order-sm-1">
                        <a href="https://laravel.com/" target="_blank" rel="noopener noreferrer">
                            <svg xmlns="http://www.w3.org/2000/svg" width="auto" height="16rem" viewBox="0 0 50 52">
        ...
        <div class="card animate__animated animate__backInUp">
            <div class="flex flex-column flex-gap-1">
                ...
                <div class="flex flex-sm-column flex-md-row flex-lg-column flex-gap-1 align-items-center">
                    ...
                    <p class="order-1 order-sm-2">
                        HTML5, CSS3 - SASS, Javascript, ReactJS

                    <div class="order-2 order-sm-1" target="_blank" rel="noopener noreferrer">
                        <a href="https://reactjs.org/">
                            <svg xmlns="http://www.w3.org/2000/svg" width="auto" height="16rem" viewBox="-11.5 -10.23174 23 20.46348">
        ...
        <div class="card animate__animated animate__backInUp">
            <div class="flex flex-column flex-gap-1">
                ...
                <div class="flex flex-sm-column flex-md-row flex-lg-column flex-gap-1 align-items-center">
                    ...
                    <p class="order-1 order-sm-2">
                        RDBMS(MySQL, PostrgeSQL), NOSQL (MongoDB)

                    <div class="order-2 order-sm-1">
                        <a href="https://dev.mysql.com/" target="_blank" rel="noopener noreferrer">
                            <svg xmlns="http://www.w3.org/2000/svg" width="auto" height="16rem" viewBox="-58.46985 -50.32625 506.7387 301.9575">
                ...
                <div class="flex flex-sm-column flex-md-row flex-lg-column flex-gap-1 align-items-center">
                    ...
                    <div class="order-2 order-sm-1">
                        <a href="https://developer.android.com/" target="_blank" rel="noopener noreferrer">
                            <svg xmlns="http://www.w3.org/2000/svg" width="auto" height="16rem" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="-147 -70 294 345">
                                <g fill="#77C159">
